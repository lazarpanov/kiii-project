...
public class AuthorServiceImpl implements AuthorService {
    ...
    @Override
    public List<Author> findByNameOrSurname(String name, String surname) {
        return this.authorRepository.findAuthorsByNameContainingIgnoreCaseOrSurnameContainingIgnoreCase(name, surname);
    }
